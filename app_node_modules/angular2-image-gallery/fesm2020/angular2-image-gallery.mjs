...
import { Injectable, Component, Input, EventEmitter, Output, ViewChild, ViewChildren, HostListener, NgModule } from '@angular/core';
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "15.1.1", ngImport: i0, type: ViewerComponent, decorators: [{
        ...
        }], ctorParameters: function () { return [{ type: ImageService }, { type: i2.DomSanitizer }]; }, propDecorators: { baseImagesURL: [{
                type: Input,
                args: ['baseImagesURL']
            }] } });
